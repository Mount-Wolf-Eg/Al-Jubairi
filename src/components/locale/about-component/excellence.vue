<template>
  <div class="legal">
    ...
    <div
      class="legal-expertise d-flex align-items-center justify-content-center flex-column flex-md-row gap-3 gap-md-0 mx-auto pt-5"
    >
      <div
      ...
      >
        <img
          ...
          :alt="item.image?.alt"
        />
        <div class="expertise-text" v-html="item.desc"></div>
        <!-- {{ item.desc }} -->
      </div>
    </div>
  </div>
